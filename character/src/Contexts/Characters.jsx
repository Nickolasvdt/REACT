...
function Characters ({children}) {
    ...
    return (
        <CharacterList.Provider value={[[character, setCharacter], [selectedCharacter, setSelectedCharacter], [maxCharacters], [modalIsOpen, setModalIsOpen], [tempCharacter, setTempCharacter]]}>
            {children}
